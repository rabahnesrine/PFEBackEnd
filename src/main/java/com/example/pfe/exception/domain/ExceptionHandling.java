...
public class ExceptionHandling {
   ...
   private final static String ACCOUNT_LOCKED="your account has been locked.Please contact administration";
    ...
    private  final static String INTERNAL_SERVER_ERROR_MSG="An error occurred while processing in request";
    private static final String INCORRECT_CREDENTIALS="usename/password incorrect.Please try again";
private final static String ACCOUNT_DISABLED="You account has been disabled.if this is an error, please contact administration";
...
public ResponseEntity<HttpResponse> accountDisabledException(){
    ...
    // si aautres exception donc exception class  (internalServerError)
